                    ...
                    <div className="space-y-12 md:space-y-24">
                        {steps.map((step, index) => (
                            ...
                            >
                                ...
                                {/* Left Side Box: On Desktop Even items. On Mobile ALL items. */}
                                <div className={`w-full pl-20 md:w-1/2 md:pl-0 md:pr-16 ${index % 2 === 1 ? "md:hidden" : ""}`}>
                                    <div className={`relative z-10 rounded-2xl border border-white/10 bg-white/5 p-6 transition-colors hover:bg-white/10 ${index % 2 === 1 ? "text-left" : "md:text-right text-left"}`}>
                                ...
                                {/* Right Side Box: Desktop Odd items only. Mobile: Hidden. */}
                                <div className={`w-full pl-20 md:w-1/2 md:pl-16 hidden md:block`}>
                                    {index % 2 === 1 && (
